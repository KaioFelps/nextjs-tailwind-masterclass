export default function Home() {
  return (
    // prose is a tailwindcss plugin for parsing pginations styles
    <main className="
    prose prose-invert prose-headings:text-zinc-100 prose-headings:font-semibold prose-h1:text-3xl prose-h2:text-xl prose-h2:font-medium prose-p:text-zinc-400 prose-pre:border prose-pre:border-white/10 prose-pre:rounded-2xl prose-a:text-cyan-400 prose-pre:bg-zinc-900
    ">
